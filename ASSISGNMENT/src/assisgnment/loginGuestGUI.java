 ...
 * @author Acer
 */
public class loginGuestGUI extends javax.swing.JFrame {

    /**
     * Creates new form loginGuestGUI
     */
    public loginGuestGUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("AMIRUL SCREEN CINEMA");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        loginStaffGUI a = new loginStaffGUI();
        a.show();
        dispose();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        registerGuestGUI a = new registerGuestGUI();
        a.show();
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(loginGuestGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new loginGuestGUI().setVisible(true);
            }
        });
    }
